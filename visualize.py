...
def plotIntersection(R=8):
    ...
    T3 = np.ndarray((Nr, Ntheta))

    # T1: temperature mapping from front
    # T2: temperature mapping from upward
    # T3: temperature mapping from left
    ...
    pc3 = ax3.pcolormesh(theta, r, T3, cmap="plasma",  shading='auto')
    fig.colorbar(pc3)    
    plt.show()    
